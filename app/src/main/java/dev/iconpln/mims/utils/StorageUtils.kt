...
object StorageUtils {
    ...
    fun getDirectory(directory: Int): String {
        when (directory) {
            DIRECTORY_ROOT -> return Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)
                .toString() + "/" + Config.DIRECTORY_ROOT_NAME

            DIRECTORY_CACHE -> return Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)
                .toString() + "/" + Config.DIRECTORY_ROOT_NAME + "/Caches"

            DIRECTORY_IMAGE -> return Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)
                .toString() + "/" + Config.DIRECTORY_ROOT_NAME + "/Images"

            DIRECTORY_REPORT_LOG -> return Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)
                .toString() + "/" + Config.DIRECTORY_ROOT_NAME + "/log_report.sys"

            DIRECTORY_DATABASE -> return Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)
                .toString() + "/" + Config.DIRECTORY_ROOT_NAME + "/Databases"

            DIRECTORY_PDF -> return Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)
                .toString() + "/" + Config.DIRECTORY_ROOT_NAME + "/Pdf"
...
//            DIRECTORY_DATABASE -> return Environment.getExternalStoragePublicDirectory("").toString() + "/Android/media/" + Config.DIRECTORY_ROOT_NAME + "/Databases"
            DIRECTORY_PDF -> return Environment.getExternalStoragePublicDirectory("")
                .toString() + "/Android/media/" + Config.DIRECTORY_ROOT_NAME + "/Pdf"
