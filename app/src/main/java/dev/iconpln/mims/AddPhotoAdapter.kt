...
class AddPhotoAdapter(
    val lisModels: MutableList<dev.iconpln.mims.data.local.database.TPhoto>,
    ...
    fun setPhotoList(photo: List<dev.iconpln.mims.data.local.database.TPhoto>) {
        lisModels.clear()
    ...
    interface OnAdapterListener {
        fun onClick(po: dev.iconpln.mims.data.local.database.TPhoto)
    }
