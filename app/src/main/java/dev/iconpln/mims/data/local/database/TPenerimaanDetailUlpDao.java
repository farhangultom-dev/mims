...
public class TPenerimaanDetailUlpDao extends AbstractDao<TPenerimaanDetailUlp, Long> {
    ...
    public static class Properties {
        ...
        public final static Property ValuationType = new Property(10, String.class, "ValuationType", false, "VALUATION_TYPE");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TPENERIMAAN_DETAIL_ULP\" (" + //
                ...
                "\"VALUATION_TYPE\" TEXT," + // 10: ValuationType
    ...
    protected final void bindValues(DatabaseStatement stmt, TPenerimaanDetailUlp entity) {
        ...
        if (ValuationType != null) {
            stmt.bindString(11, ValuationType);
        }
    ...
    public TPenerimaanDetailUlp readEntity(Cursor cursor, int offset) {
        TPenerimaanDetailUlp entity = new TPenerimaanDetailUlp( //
            ...
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), // ValuationType
    ...
    public void readEntity(Cursor cursor, TPenerimaanDetailUlp entity, int offset) {
        ...
        entity.setValuationType(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
