...
public class TPosDetailDao extends AbstractDao<TPosDetail, Long> {
    ...
    public static class Properties {
        ...
        public final static Property NamaPabrikan = new Property(17, String.class, "NamaPabrikan", false, "NAMA_PABRIKAN");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TPOS_DETAIL\" (" + //
                ...
                "\"NAMA_PABRIKAN\" TEXT);"); // 17: NamaPabrikan
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, TPosDetail entity) {
        ...
        if (NamaPabrikan != null) {
            stmt.bindString(18, NamaPabrikan);
        }
    }
    ...
    public TPosDetail readEntity(Cursor cursor, int offset) {
        TPosDetail entity = new TPosDetail( //
            ...
            cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17) // NamaPabrikan
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, TPosDetail entity, int offset) {
        ...
        entity.setNamaPabrikan(cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17));
     }
