...
public class TMonitoringSnMaterialDao extends AbstractDao<TMonitoringSnMaterial, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Packaging = new Property(4, String.class, "Packaging", false, "PACKAGING");
        public final static Property Status = new Property(5, String.class, "Status", false, "STATUS");
        public final static Property IsScanned = new Property(6, Integer.class, "IsScanned", false, "IS_SCANNED");
        public final static Property ValuationType = new Property(7, String.class, "ValuationType", false, "VALUATION_TYPE");
        public final static Property NoIdMeter = new Property(8, String.class, "NoIdMeter", false, "NO_ID_METER");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TMONITORING_SN_MATERIAL\" (" + //
                ...
                "\"PACKAGING\" TEXT," + // 4: Packaging
                "\"STATUS\" TEXT," + // 5: Status
                "\"IS_SCANNED\" INTEGER," + // 6: IsScanned
                "\"VALUATION_TYPE\" TEXT," + // 7: ValuationType
                "\"NO_ID_METER\" TEXT);"); // 8: NoIdMeter
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, TMonitoringSnMaterial entity) {
        ...
        String Packaging = entity.getPackaging();
        if (Packaging != null) {
            stmt.bindString(5, Packaging);
        }
        ...
        if (IsScanned != null) {
            stmt.bindLong(7, IsScanned);
        }
 
        String ValuationType = entity.getValuationType();
        if (ValuationType != null) {
            stmt.bindString(8, ValuationType);
        }
 
        String NoIdMeter = entity.getNoIdMeter();
        if (NoIdMeter != null) {
            stmt.bindString(9, NoIdMeter);
        }
    }
    ...
    public TMonitoringSnMaterial readEntity(Cursor cursor, int offset) {
        TMonitoringSnMaterial entity = new TMonitoringSnMaterial( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // Packaging
            cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), // Status
            cursor.isNull(offset + 6) ? null : cursor.getInt(offset + 6), // IsScanned
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // ValuationType
            cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8) // NoIdMeter
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, TMonitoringSnMaterial entity, int offset) {
        ...
        entity.setPackaging(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
        entity.setStatus(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
        entity.setIsScanned(cursor.isNull(offset + 6) ? null : cursor.getInt(offset + 6));
        entity.setValuationType(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
        entity.setNoIdMeter(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
     }
