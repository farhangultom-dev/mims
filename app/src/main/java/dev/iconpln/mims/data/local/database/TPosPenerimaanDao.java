...
public class TPosPenerimaanDao extends AbstractDao<TPosPenerimaan, Long> {
    ...
    public static class Properties {
        ...
        public final static Property NamaPabrikan = new Property(35, String.class, "NamaPabrikan", false, "NAMA_PABRIKAN");
        public final static Property BisaTerima = new Property(36, Integer.class, "BisaTerima", false, "BISA_TERIMA");
        public final static Property IsRating = new Property(37, Integer.class, "IsRating", false, "IS_RATING");
        public final static Property IsDone = new Property(38, Integer.class, "isDone", false, "IS_DONE");
        public final static Property RatingDone = new Property(39, Integer.class, "ratingDone", false, "RATING_DONE");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TPOS_PENERIMAAN\" (" + //
                ...
                "\"NAMA_PABRIKAN\" TEXT," + // 35: NamaPabrikan
                "\"BISA_TERIMA\" INTEGER," + // 36: BisaTerima
                "\"IS_RATING\" INTEGER," + // 37: IsRating
                "\"IS_DONE\" INTEGER," + // 38: isDone
                "\"RATING_DONE\" INTEGER);"); // 39: ratingDone
    }
    ...
    public TPosPenerimaan readEntity(Cursor cursor, int offset) {
        TPosPenerimaan entity = new TPosPenerimaan( //
            ...
            cursor.isNull(offset + 35) ? null : cursor.getString(offset + 35), // NamaPabrikan
            cursor.isNull(offset + 36) ? null : cursor.getInt(offset + 36), // BisaTerima
            cursor.isNull(offset + 37) ? null : cursor.getInt(offset + 37), // IsRating
            cursor.isNull(offset + 38) ? null : cursor.getInt(offset + 38), // isDone
            cursor.isNull(offset + 39) ? null : cursor.getInt(offset + 39) // ratingDone
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, TPosPenerimaan entity, int offset) {
        ...
        entity.setNamaPabrikan(cursor.isNull(offset + 35) ? null : cursor.getString(offset + 35));
        entity.setBisaTerima(cursor.isNull(offset + 36) ? null : cursor.getInt(offset + 36));
        entity.setIsRating(cursor.isNull(offset + 37) ? null : cursor.getInt(offset + 37));
        entity.setIsDone(cursor.isNull(offset + 38) ? null : cursor.getInt(offset + 38));
        entity.setRatingDone(cursor.isNull(offset + 39) ? null : cursor.getInt(offset + 39));
     }
