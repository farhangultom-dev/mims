...
public class TMonitoringPermintaanDetailDao extends AbstractDao<TMonitoringPermintaanDetail, Long> {
    ...
    public static class Properties {
        ...
        public final static Property ValuationType = new Property(12, String.class, "ValuationType", false, "VALUATION_TYPE");
        public final static Property JumlahKardus = new Property(13, Integer.class, "JumlahKardus", false, "JUMLAH_KARDUS");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TMONITORING_PERMINTAAN_DETAIL\" (" + //
                ...
                "\"VALUATION_TYPE\" TEXT," + // 12: ValuationType
                "\"JUMLAH_KARDUS\" INTEGER);"); // 13: JumlahKardus
    }
    ...
    public TMonitoringPermintaanDetail readEntity(Cursor cursor, int offset) {
        TMonitoringPermintaanDetail entity = new TMonitoringPermintaanDetail( //
            ...
            cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12), // ValuationType
            cursor.isNull(offset + 13) ? null : cursor.getInt(offset + 13) // JumlahKardus
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, TMonitoringPermintaanDetail entity, int offset) {
        ...
        entity.setValuationType(cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12));
        entity.setJumlahKardus(cursor.isNull(offset + 13) ? null : cursor.getInt(offset + 13));
     }
