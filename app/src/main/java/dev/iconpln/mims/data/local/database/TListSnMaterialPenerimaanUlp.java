...
public class TListSnMaterialPenerimaanUlp {
    ...
    @Generated
    public TListSnMaterialPenerimaanUlp(Long id, String NoRepackaging, String NoMaterial, String NoSerialNumber, String Status, Integer IsScanned, String ValuationType) {
        this.id = id;
