...
public class TPosDao extends AbstractDao<TPos, Long> {
    ...
    public static class Properties {
        ...
        public final static Property BackgroundColor = new Property(36, String.class, "BackgroundColor", false, "BACKGROUND_COLOR");
        public final static Property TextColor = new Property(37, String.class, "TextColor", false, "TEXT_COLOR");
        public final static Property NamaPabrikan = new Property(38, String.class, "NamaPabrikan", false, "NAMA_PABRIKAN");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TPOS\" (" + //
                ...
                "\"ETA\" TEXT," + // 34: Eta
                "\"ETD\" TEXT," + // 35: Etd
                "\"BACKGROUND_COLOR\" TEXT," + // 36: BackgroundColor
                "\"TEXT_COLOR\" TEXT," + // 37: TextColor
                "\"NAMA_PABRIKAN\" TEXT);"); // 38: NamaPabrikan
    }
    ...
    public TPos readEntity(Cursor cursor, int offset) {
        TPos entity = new TPos( //
            ...
            cursor.isNull(offset + 36) ? null : cursor.getString(offset + 36), // BackgroundColor
            cursor.isNull(offset + 37) ? null : cursor.getString(offset + 37), // TextColor
            cursor.isNull(offset + 38) ? null : cursor.getString(offset + 38) // NamaPabrikan
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, TPos entity, int offset) {
        ...
        entity.setBackgroundColor(cursor.isNull(offset + 36) ? null : cursor.getString(offset + 36));
        entity.setTextColor(cursor.isNull(offset + 37) ? null : cursor.getString(offset + 37));
        entity.setNamaPabrikan(cursor.isNull(offset + 38) ? null : cursor.getString(offset + 38));
     }
