...
public class TPosSnsDao extends AbstractDao<TPosSns, Long> {
    ...
    public static class Properties {
        ...
        public final static Property NamaPabrikan = new Property(22, String.class, "NamaPabrikan", false, "NAMA_PABRIKAN");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TPOS_SNS\" (" + //
                ...
                "\"NAMA_PABRIKAN\" TEXT);"); // 22: NamaPabrikan
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, TPosSns entity) {
        ...
        if (NamaPabrikan != null) {
            stmt.bindString(23, NamaPabrikan);
        }
    }
    ...
    public TPosSns readEntity(Cursor cursor, int offset) {
        TPosSns entity = new TPosSns( //
            ...
            cursor.isNull(offset + 22) ? null : cursor.getString(offset + 22) // NamaPabrikan
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, TPosSns entity, int offset) {
        ...
        entity.setNamaPabrikan(cursor.isNull(offset + 22) ? null : cursor.getString(offset + 22));
     }
