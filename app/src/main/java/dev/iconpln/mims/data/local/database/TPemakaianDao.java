...
public class TPemakaianDao extends AbstractDao<TPemakaian, Long> {
    ...
    public static class Properties {
        ...
        public final static Property NoBon = new Property(29, String.class, "NoBon", false, "NO_BON");
        public final static Property IsDonePemakai = new Property(30, Integer.class, "IsDonePemakai", false, "IS_DONE_PEMAKAI");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TPEMAKAIAN\" (" + //
                ...
                "\"NO_BON\" TEXT," + // 29: NoBon
                "\"IS_DONE_PEMAKAI\" INTEGER," + // 30: IsDonePemakai
    ...
    protected final void bindValues(DatabaseStatement stmt, TPemakaian entity) {
        ...
        String NoBon = entity.getNoBon();
        if (NoBon != null) {
            stmt.bindString(30, NoBon);
        }
 
        Integer IsDonePemakai = entity.getIsDonePemakai();
        if (IsDonePemakai != null) {
            stmt.bindLong(31, IsDonePemakai);
        }
    ...
    public TPemakaian readEntity(Cursor cursor, int offset) {
        TPemakaian entity = new TPemakaian( //
            ...
            cursor.isNull(offset + 29) ? null : cursor.getString(offset + 29), // NoBon
            cursor.isNull(offset + 30) ? null : cursor.getInt(offset + 30), // IsDonePemakai
    ...
    public void readEntity(Cursor cursor, TPemakaian entity, int offset) {
        ...
        entity.setNoBon(cursor.isNull(offset + 29) ? null : cursor.getString(offset + 29));
        entity.setIsDonePemakai(cursor.isNull(offset + 30) ? null : cursor.getInt(offset + 30));
