...
public class TDataRating {
    ...
    @Generated
    public TDataRating(Long id, Integer Ketepatan, String RatingQuality, String RatingDelivery, Boolean SelesaiRating, String NoDoSmar, String RatingResponse, String NoRating) {
        this.id = id;
