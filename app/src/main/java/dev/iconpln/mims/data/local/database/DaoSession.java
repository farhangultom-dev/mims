...
import dev.iconpln.mims.data.local.database.TDoStatusDao;
import dev.iconpln.mims.data.local.database.TPejabatDao;
import dev.iconpln.mims.data.local.database.TAGOMaterialDataDao;
...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig tDoStatusDaoConfig;
    private final DaoConfig tPejabatDaoConfig;
    private final DaoConfig tAGOMaterialDataDaoConfig;
    ...
    private final TDoStatusDao tDoStatusDao;
    private final TPejabatDao tPejabatDao;
    private final TAGOMaterialDataDao tAGOMaterialDataDao;
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        tDoStatusDaoConfig = daoConfigMap.get(TDoStatusDao.class).clone();
        tDoStatusDaoConfig.initIdentityScope(type);

        tPejabatDaoConfig = daoConfigMap.get(TPejabatDao.class).clone();
        tPejabatDaoConfig.initIdentityScope(type);

        tAGOMaterialDataDaoConfig = daoConfigMap.get(TAGOMaterialDataDao.class).clone();
        tAGOMaterialDataDaoConfig.initIdentityScope(type);
        ...
        tDoStatusDao = new TDoStatusDao(tDoStatusDaoConfig, this);
        tPejabatDao = new TPejabatDao(tPejabatDaoConfig, this);
        tAGOMaterialDataDao = new TAGOMaterialDataDao(tAGOMaterialDataDaoConfig, this);
        ...
        registerDao(TDoStatus.class, tDoStatusDao);
        registerDao(TPejabat.class, tPejabatDao);
        registerDao(TAGOMaterialData.class, tAGOMaterialDataDao);
    }
    ...
    public void clear() {
        ...
        tDoStatusDaoConfig.clearIdentityScope();
        tPejabatDaoConfig.clearIdentityScope();
        tAGOMaterialDataDaoConfig.clearIdentityScope();
    }
    ...
    public TDoStatusDao getTDoStatusDao() {
        return tDoStatusDao;
    }

    public TPejabatDao getTPejabatDao() {
        return tPejabatDao;
    }

    public TAGOMaterialDataDao getTAGOMaterialDataDao() {
        return tAGOMaterialDataDao;
    }
