...
public class TTransDataRatingDao extends AbstractDao<TTransDataRating, Long> {
    ...
    public static class Properties {
        ...
        public final static Property NoRating = new Property(7, String.class, "NoRating", false, "NO_RATING");
        public final static Property IsDone = new Property(8, Integer.class, "IsDone", false, "IS_DONE");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TTRANS_DATA_RATING\" (" + //
                ...
                "\"NO_RATING\" TEXT," + // 7: NoRating
                "\"IS_DONE\" INTEGER);"); // 8: IsDone
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, TTransDataRating entity) {
        ...
        String NoRating = entity.getNoRating();
        if (NoRating != null) {
            stmt.bindString(8, NoRating);
        }
 
        Integer IsDone = entity.getIsDone();
        if (IsDone != null) {
            stmt.bindLong(9, IsDone);
        }
    }
    ...
    public TTransDataRating readEntity(Cursor cursor, int offset) {
        TTransDataRating entity = new TTransDataRating( //
            ...
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // NoRating
            cursor.isNull(offset + 8) ? null : cursor.getInt(offset + 8) // IsDone
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, TTransDataRating entity, int offset) {
        ...
        entity.setNoRating(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
        entity.setIsDone(cursor.isNull(offset + 8) ? null : cursor.getInt(offset + 8));
     }
