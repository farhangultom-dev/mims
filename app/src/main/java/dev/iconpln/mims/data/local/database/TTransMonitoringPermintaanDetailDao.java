...
public class TTransMonitoringPermintaanDetailDao extends AbstractDao<TTransMonitoringPermintaanDetail, Long> {
    ...
    public static class Properties {
        ...
        public final static Property ValuationType = new Property(15, String.class, "ValuationType", false, "VALUATION_TYPE");
        public final static Property JumlahKardus = new Property(16, Integer.class, "JumlahKardus", false, "JUMLAH_KARDUS");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TTRANS_MONITORING_PERMINTAAN_DETAIL\" (" + //
                ...
                "\"VALUATION_TYPE\" TEXT," + // 15: ValuationType
                "\"JUMLAH_KARDUS\" INTEGER);"); // 16: JumlahKardus
    }
    ...
    public TTransMonitoringPermintaanDetail readEntity(Cursor cursor, int offset) {
        TTransMonitoringPermintaanDetail entity = new TTransMonitoringPermintaanDetail( //
            ...
            cursor.isNull(offset + 15) ? null : cursor.getString(offset + 15), // ValuationType
            cursor.isNull(offset + 16) ? null : cursor.getInt(offset + 16) // JumlahKardus
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, TTransMonitoringPermintaanDetail entity, int offset) {
        ...
        entity.setValuationType(cursor.isNull(offset + 15) ? null : cursor.getString(offset + 15));
        entity.setJumlahKardus(cursor.isNull(offset + 16) ? null : cursor.getInt(offset + 16));
     }
