...
public class TMonitoringPermintaanDao extends AbstractDao<TMonitoringPermintaan, Long> {
    ...
    public static class Properties {
        ...
        public final static Property ValuationType = new Property(18, String.class, "ValuationType", false, "VALUATION_TYPE");
        public final static Property TotalQtyPermintaan = new Property(19, String.class, "totalQtyPermintaan", false, "TOTAL_QTY_PERMINTAAN");
        public final static Property TotalScanQty = new Property(20, String.class, "totalScanQty", false, "TOTAL_SCAN_QTY");
        public final static Property NoPengiriman = new Property(21, String.class, "noPengiriman", false, "NO_PENGIRIMAN");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TMONITORING_PERMINTAAN\" (" + //
                ...
                "\"VALUATION_TYPE\" TEXT," + // 18: ValuationType
                "\"TOTAL_QTY_PERMINTAAN\" TEXT," + // 19: totalQtyPermintaan
                "\"TOTAL_SCAN_QTY\" TEXT," + // 20: totalScanQty
                "\"NO_PENGIRIMAN\" TEXT);"); // 21: noPengiriman
    }
    ...
    public TMonitoringPermintaan readEntity(Cursor cursor, int offset) {
        TMonitoringPermintaan entity = new TMonitoringPermintaan( //
            ...
            cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18), // ValuationType
            cursor.isNull(offset + 19) ? null : cursor.getString(offset + 19), // totalQtyPermintaan
            cursor.isNull(offset + 20) ? null : cursor.getString(offset + 20), // totalScanQty
            cursor.isNull(offset + 21) ? null : cursor.getString(offset + 21) // noPengiriman
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, TMonitoringPermintaan entity, int offset) {
        ...
        entity.setValuationType(cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18));
        entity.setTotalQtyPermintaan(cursor.isNull(offset + 19) ? null : cursor.getString(offset + 19));
        entity.setTotalScanQty(cursor.isNull(offset + 20) ? null : cursor.getString(offset + 20));
        entity.setNoPengiriman(cursor.isNull(offset + 21) ? null : cursor.getString(offset + 21));
     }
