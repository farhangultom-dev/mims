...
class PengujianDetailAdapter(
    val lisModels: MutableList<dev.iconpln.mims.data.local.database.TPengujianDetails>,
    var listener: OnAdapterListener
) : RecyclerView.Adapter<PengujianDetailAdapter.ViewHolder>() {

    fun setPengujianList(pengujian: List<dev.iconpln.mims.data.local.database.TPengujianDetails>) {
        lisModels.clear()
    ...
    override fun onCreateViewHolder(
        ...
        val binding = ItemListDetailPengujianBinding.inflate(
    ...
    inner class ViewHolder(val binding: ItemListDetailPengujianBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(pengujian: dev.iconpln.mims.data.local.database.TPengujianDetails) {
            with(binding) {
    ...
    interface OnAdapterListener {
        fun onClick(pengujian: dev.iconpln.mims.data.local.database.TPengujianDetails)
    }
}