...
class DetailPemeriksaanActivity : BaseActivity(), Loadable {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dialogLoading = dev.iconpln.mims.utils.Helper.loadingDialog(this)
        ...
        adapter = DetailPemeriksaanUlpAdapter(
            arrayListOf(),
            object : DetailPemeriksaanUlpAdapter.OnAdapterListener {
                override fun onClick(po: dev.iconpln.mims.data.local.database.TTransPenerimaanDetailUlp) {
                    if (!po.isActive) {
                        Toast.makeText(
                            this@DetailPemeriksaanActivity,
                        ...
                        if (po.isDone == 1) {
                            Toast.makeText(
                                this@DetailPemeriksaanActivity,
                                "Kamu sudah menyelesaikan material ini",
                                Toast.LENGTH_SHORT
                            ).show()
                        } else {
                            startActivity(
                                Intent(
                                    this@DetailPemeriksaanActivity,
                                    InputSnPemeriksaanActivity::class.java
                                )
                                    .putExtra(InputSnPemeriksaanActivity.EXTRA_NO_MATERIAL, po.noMaterial)
                                    .putExtra(InputSnPemeriksaanActivity.EXTRA_NO_REPACKAGING, po.noRepackaging)
                                    .putExtra(InputSnPemeriksaanActivity.EXTRA_NO_TRANSAKSI, po.noTransaksi)
                                    .putExtra(InputSnPemeriksaanActivity.EXTRA_VALUATION_TYPE, po.valuationType)
                            )
                        }
                    }
                }
        ...
        with(binding) {
            ...
            rvDetailPemeriksaan.layoutManager = LinearLayoutManager(
                this@DetailPemeriksaanActivity,
            ...
            btnSelesai.setOnClickListener { validation() }
        }
    }
    ...
    private fun submitForm() {
        ...
        var plant =
            SharedPrefsUtils.getStringPreference(this@DetailPemeriksaanActivity, "plant", "")
        var storloc =
            SharedPrefsUtils.getStringPreference(this@DetailPemeriksaanActivity, "storloc", "")
        ...
        val reportId =
            "temp_pemeriksaanUlp" + username + "_" + penerimaans.noPermintaan + "_" + DateTime.now()
                .toString(
                    Config.DATETIME
                )
        ...
        params.add(
            ReportParameter(
                ...
                reportId,
                "no_transaksi",
                detailPemeriksaans[0].noTransaksi!!,
        ...
        val report = GenericReport(
            ...
            reportName,
            reportDescription,
            ApiConfig.sendReportPenerimaanUlpSelesai(),
            currentDate,
            Config.NO_CODE,
            currentUtc,
            params
        ...
        val reportIdPetugasPemeriksaan =
            "temp_petugasPemeriksaanUlp" + username + "_" + penerimaans.noPermintaan + "_" + DateTime.now()
                .toString(
                    Config.DATETIME
                )
        val reportNamePetugasPemeriksaan = "Update Data petugas pemeriksaan ulp"
        val reportDescriptionPetugasPemeriksaan =
            "$reportNamePetugasPemeriksaan: " + " (" + reportIdPetugasPemeriksaan + ")"
        val paramsPetugasPemeriksaan = ArrayList<ReportParameter>()

        paramsPetugasPemeriksaan.add(
            ReportParameter(
                "1",
                reportIdPetugasPemeriksaan,
                "tgl_pemeriksaan",
                penerimaans.tanggalPemeriksaan,
                ReportParameter.TEXT
            )
        )
        paramsPetugasPemeriksaan.add(
            ReportParameter(
                ...
                reportIdPetugasPemeriksaan,
                "kepala_gudang",
                penerimaans.kepalaGudangPemeriksa,
                ReportParameter.TEXT
            )
        )
        paramsPetugasPemeriksaan.add(
        ...
        paramsPetugasPemeriksaan.add(
            ReportParameter(
                ...
                reportIdPetugasPemeriksaan,
                "nama_pemeriksa_2",
                penerimaans.namaPetugasPemeriksa!!,
                ReportParameter.TEXT
            )
        )
        paramsPetugasPemeriksaan.add(
            ReportParameter(
                ...
                reportIdPetugasPemeriksaan,
                "jabatan_pemeriksa_2",
                penerimaans.jabatanPetugasPemeriksa!!,
                ReportParameter.TEXT
            )
        )
        paramsPetugasPemeriksaan.add(
        ...
        val reportPetugas = GenericReport(
            reportIdPetugasPemeriksaan,
            jwt!!,
            reportNamePetugasPemeriksaan,
            reportDescriptionPetugasPemeriksaan,
            ApiConfig.sendReportPetugasPemeriksaanUlp(),
            currentDate,
            Config.NO_CODE,
            currentUtc,
            paramsPetugasPemeriksaan
        )
        reports.add(reportPetugas)

        //endregion
        val reportIdPetugasPenerimaan =
            "temp_petugasPenerimaanUlp" + username + "_" + penerimaans.noPermintaan + "_" + DateTime.now()
                .toString(
                    Config.DATETIME
                )
        val reportNamePetugasPenerimaan = "Update Data petugas penerimaan ulp"
        val reportDescriptionPetugasPenerimaan =
            "$reportNamePetugasPenerimaan: " + " (" + reportIdPetugasPenerimaan + ")"
        val paramsPetugasPenerimaan = ArrayList<ReportParameter>()

        paramsPetugasPenerimaan.add(
            ReportParameter(
                "1",
                reportIdPetugasPenerimaan,
                "nama_penerima",
                penerimaans.pejabatPenerima,
                ReportParameter.TEXT
            )
        )
        paramsPetugasPenerimaan.add(
        ...
        val reportPetugasPenerimaan = GenericReport(
            reportIdPetugasPenerimaan,
            jwt!!,
            reportNamePetugasPenerimaan,
            reportDescriptionPetugasPenerimaan,
            ApiConfig.sendReportPetugasPenerimaanUlp(),
            currentDate,
            Config.NO_CODE,
            currentUtc,
            paramsPetugasPenerimaan
        )
    ...
    override fun setFinish(result: Boolean, message: String) {
        ...
        startActivity(
            Intent(this@DetailPemeriksaanActivity, PenerimaanUlpActivity::class.java)
