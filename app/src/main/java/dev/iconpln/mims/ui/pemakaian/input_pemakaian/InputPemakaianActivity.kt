...
import dev.iconpln.mims.ui.pemakaian.DetailPemakaianUlpMandiriActivity
...
class InputPemakaianActivity : BaseActivity(), Loadable {
    ...
    private fun validation() {
        with(binding) {
            ...
            if (noPk.isNullOrEmpty()) {
                Toast.makeText(
                    this@InputPemakaianActivity,
                    "Mohon lengkapi data yang di butuhkan",
                    Toast.LENGTH_SHORT
                ).show()
                return
            }
    ...
    private fun submitForm(
        ...
        val reportId =
            "temp_input_pemakaian Ulp" + username + "_" + pemakaian.noTransaksi + "_" + DateTime.now()
                .toString(
                    Config.DATETIME
                )
    ...
    override fun setFinish(result: Boolean, message: String) {
        ...
        startActivity(
            Intent(this@InputPemakaianActivity, DetailPemakaianUlpMandiriActivity::class.java)
