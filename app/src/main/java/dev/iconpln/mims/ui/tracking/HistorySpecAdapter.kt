...
class HistorySpecAdapter(
    val lisModels: MutableList<HistorisItem>,
    ...
    override fun onCreateViewHolder(
        ...
        val binding = ItemTrackingMaterialHistoryBinding.inflate(
    ...
    inner class ViewHolder(val binding: ItemTrackingMaterialHistoryBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(data: HistorisItem) {
            with(binding) {
                if (data.statusName.isNullOrEmpty()) txtSpec.text = "-" else txtSpec.text =
                    data.statusName
            }
