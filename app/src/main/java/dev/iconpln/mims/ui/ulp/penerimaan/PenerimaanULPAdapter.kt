...
class PenerimaanULPAdapter(
    val lisModels: MutableList<dev.iconpln.mims.data.local.database.TTransPenerimaanUlp>,
    var listener: OnAdapterListener
) : RecyclerView.Adapter<PenerimaanULPAdapter.ViewHolder>() {

    fun setPenerimaanList(mat: List<dev.iconpln.mims.data.local.database.TTransPenerimaanUlp>) {
        lisModels.clear()
    ...
    override fun onCreateViewHolder(
        ...
        val binding = ItemDataPemeriksaanulpBinding.inflate(
    ...
    inner class ViewHolder(val binding: ItemDataPemeriksaanulpBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(pengujian: dev.iconpln.mims.data.local.database.TTransPenerimaanUlp) {
            with(binding) {
                ...
                txtTanggalPenerimaan.text =
                    if (pengujian.tanggalPenerimaan.isNullOrEmpty()) "-" else pengujian.tanggalPenerimaan
    ...
    interface OnAdapterListener {
        fun onClick(pengujian: dev.iconpln.mims.data.local.database.TTransPenerimaanUlp)
    }
}