...
class MonitoringComplaintDetailAdapter(
    val lisModels: MutableList<dev.iconpln.mims.data.local.database.TMonitoringComplaintDetail>,
    ...
    fun setComplaint(complaint: List<dev.iconpln.mims.data.local.database.TMonitoringComplaintDetail>) {
        lisModels.clear()
    ...
    override fun onCreateViewHolder(
        ...
        val binding = ItemListMonitoringKomplainBinding.inflate(
    ...
    override fun onBindViewHolder(
        holder: MonitoringComplaintDetailAdapter.ViewHolder,
        position: Int
    ) {
    ...
    inner class ViewHolder(val binding: ItemListMonitoringKomplainBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(complaint: dev.iconpln.mims.data.local.database.TMonitoringComplaintDetail) {
            with(binding) {
                ...
                txtTanggalSelesai.text =
                    if (complaint.tanggalSelesai.isNullOrEmpty()) "-" else complaint.tanggalSelesai
    ...
    interface OnAdapterAlasanKomplain {
        fun onClick(po: dev.iconpln.mims.data.local.database.TMonitoringComplaintDetail)
    }
}