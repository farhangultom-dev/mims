...
class ListApprovalMaterialAdapter :
    RecyclerView.Adapter<ListApprovalMaterialAdapter.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val binding =
            ItemDataApprovalBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        ...
        fun bind(item: DataItemMaterialAktivasi) {
            with(binding) {
                ...
                btnDetail.setOnClickListener {
                    ...
                    intent.putExtra(
                        DetailApprovalMaterialActivity.EXTRA_TGL_REGISTRASI,
                        item.tglRegistrasi
                    )
